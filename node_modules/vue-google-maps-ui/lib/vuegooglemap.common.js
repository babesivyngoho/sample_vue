...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".GoogleMap{height:-moz-max-content;height:max-content;background:#e5e3df}.GoogleMap .SearchArea{border:1px solid #ddd;border-radius:6px;display:flex}.GoogleMap .SearchArea input{flex:1;outline:none;border:none;height:30px;padding:10px}", ""]);
// Exports
...
var update = add("c8fda93e", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/GoogleMap.vue?vue&type=template&id=66bc9920
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", _hoisted_1, [$props.autocomplete ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", _hoisted_2, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withDirectives)((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("input", (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.mergeProps)(_ctx.$attrs, {
    ref: "SearchInput",
    class: $props.inputClass,
    disabled: $props.disabledSearch,
    "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => $data.address = $event)
  }), null, 16, _hoisted_3), [[external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.vModelDynamic, $data.address]])])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createCommentVNode)("", true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("div", {
    ref: $props.id,
    style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.normalizeStyle)($options.mapStyle)
  }, null, 4)]);
}
;// CONCATENATED MODULE: ./src/components/GoogleMap.vue?vue&type=template&id=66bc9920
...
;// CONCATENATED MODULE: ./node_modules/google-maps-loader-helper/helper.js
...
class GoogleMaps {
  ...
  */
  ...
  setNewAddress(address) {
    if (!address || !address.geometry || !address.geometry.location) return;
    const {
      location
    } = address.geometry;
  ...
  controlContainsCircles(circles, location) {
    return circles.some(circle => {
      ...
      const isIn = new this.google.maps.Circle(circle).getBounds().contains({
        lat: location.lat,
        lng: location.lng
      });
      return isIn;
...
class DrawingManager {
  ...
  **/
  ...
  get ALL_SHAPES() {
    const data = Object.values(this.shapes).map(data => Object.values(data));
    return data.flat();
  }
  ...
  getOptions(opts) {
    ...
    const options = {
      ...
      drawingControlOptions,
      circleOptions: {
        ...this.getCircleOptions(opts.circleOptions)
      },
      polygonOptions: {
        ...this.getPolygonOptions(opts.polygonOptions)
      },
      polylineOptions: {
        ...this.getPolygonOptions(opts.polylineOptions)
      },
      rectangleOptions: {
        ...this.getRectangleOptions(opts.rectangleOptions)
      },
      markerOptions: {
        ...this.getMarkerOptions(opts.rectangleOptions)
      }
    };
    return options;
  }
  ...
  setOverlayEvents({
    ...
    overlay.addListener('rightclick', () => this.removeOverlay({
      key,
      type,
      overlay
    }));
    switch (type) {
      case this.CIRCLE_SHAPE:
        overlay.addListener('radius_changed', () => this.setOverlay({
          key,
          type,
          overlay
        }));
        overlay.addListener('center_changed', () => this.setOverlay({
          key,
          type,
          overlay
        }));
        break;
      case this.RECTANGLE_SHAPE:
        overlay.addListener('bounds_changed', () => this.setOverlay({
          key,
          type,
          overlay
        }));
      ...
      case this.POLYLINE_SHAPE:
        ...
        path.addListener('insert_at', () => this.setOverlay({
          key,
          type,
          overlay
        }));
        path.addListener('remove_at', () => this.setOverlay({
          key,
          type,
          overlay
        }));
        path.addListener('set_at', () => this.setOverlay({
          key,
          type,
          overlay
        }));
        break;
      case this.MARKER_SHAPE:
        overlay.addListener('dragend', () => this.setOverlay({
          key,
          type,
          overlay
        }));
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/GoogleMap.vue?vue&type=script&lang=js


/* harmony default export */ var GoogleMapvue_type_script_lang_js = ({
  name: 'VueGoogleMapUI',
  emits: ['change-address', 'update-circle', 'update-polygon', 'update-polyline', 'update-rectangle', 'update-marker'],
  props: {
    apiKey: {
      type: String,
      required: true
  ...
  methods: {
    ...
    getShapesData() {
      ...
      return Object.values(shapeTypes).reduce((list, type) => {
    ...
    initMarker() {
      ...
      this.GoogleMaps.markerAddListener('click', () => {
        this.GoogleMaps.openInfoWindow({
...
;// CONCATENATED MODULE: ./src/components/GoogleMap.vue?vue&type=script&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/GoogleMap.vue?vue&type=style&index=0&id=66bc9920&lang=css
var GoogleMapvue_type_style_index_0_id_66bc9920_lang_css = __webpack_require__(1026);
;// CONCATENATED MODULE: ./src/components/GoogleMap.vue?vue&type=style&index=0&id=66bc9920&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(89);
;// CONCATENATED MODULE: ./src/components/GoogleMap.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(GoogleMapvue_type_script_lang_js, [['render',render]])

/* harmony default export */ var GoogleMap = (__exports__);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = (GoogleMap);
...
/******/ })()
;
//# sourceMappingURL=vuegooglemap.common.js.map