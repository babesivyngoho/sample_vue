...
var LeaderLine = function() {
  ...
  var te, g, y, S, _, o, t, h, f, p, a, i, l, v = "leader-line", M = 1, I = 2, C = 3, L = 4, n = {
    ...
    function l2() {
      ...
      e2 && (n2.call(window, e2), e2 = null), k2.forEach(function(e3) {
        var t3, n3, a3;
        if (e3.framesStart) {
          if ((t3 = i2 - e3.framesStart) >= e3.duration && e3.count && e3.loopsLeft <= 1)
        ...
        if ("string" == typeof i2 && (i2 = x2[i2]), n3 = n3 || function() {
          ...
          if (u2 = b2 / t3, s2 = [E2(0, 0)], 0 === i2[0] && 0 === i2[1] && 1 === i2[2] && 1 === i2[3])
            ...
            for (c2 = h2 = (p2 = u2) / 10; c2 <= 1; c2 += h2)
              void 0, S2 = (y2 = (f2 = c2) * f2) * f2, _2 = 3 * (m2 = 1 - f2) * y2, p2 <= (d2 = {
    ...
    e2.SVGPathElement.prototype.getPathData && e2.SVGPathElement.prototype.setPathData || function() {
      ...
      o2.prototype = {
        ...
        _parseNumber: function() {
          ...
          if (this._currentIndex !== r3)
            for (var s2 = this._currentIndex - 1, u2 = 1; r3 <= s2; )
              t2 += u2 * (this._string[s2] - "0"), s2 -= 1, u2 *= 10;
      ...
      var a2 = function(e3) {
        ...
        if (u2)
          p2 = u2[0], c2 = u2[1], d3 = u2[2], f3 = u2[3];
        else {
          var g2 = y3(e3, t2, -S3);
          e3 = g2.x, t2 = g2.y;
        ...
        return e3.forEach(function(e4) {
          if ("M" === e4.type) {
            ...
            if (0 === p2 || 0 === c2)
              ...
              U2(v2, E2, t2, n3, p2, c2, d3, f3, y3).forEach(function(e5) {
                S3.push({
                  type: "C",
                  values: e5
                }), v2 = t2, E2 = n3;
            ...
            "Z" === e4.type && (S3.push(e4), v2 = x2, E2 = b2);
          m2 = e4.type;
        }), S3;
      };
        ...
        if (e3 && e3.normalize) {
          ...
          var t2 = S2((s2 = [], c2 = p2 = h2 = u2 = null, n3.forEach(function(e4) {
            ...
            if ("M" === t3) {
              ...
              n4 = u2 + e4.values[0], a3 = h2 + e4.values[1], s2.push({
                type: "M",
                values: [n4, a3]
              }), u2 = p2 = n4, h2 = c2 = a3;
            else if ("L" === t3)
              n4 = e4.values[0], a3 = e4.values[1], s2.push({
                type: "L",
                values: [n4, a3]
              }), u2 = n4, h2 = a3;
            else if ("l" === t3)
              ...
              "c" === t3 ? (i3 = u2 + e4.values[0], o3 = h2 + e4.values[1], l3 = u2 + e4.values[2], r3 = h2 + e4.values[3], n4 = u2 + e4.values[4], a3 = h2 + e4.values[5], s2.push({
                type: "C",
                values: [i3, o3, l3, r3, n4, a3]
  ...
  function ke(e2, t2, n2, a2, i2) {
    for (var o2, l2 = 0.5, r2 = 1 - l2; o2 = be(e2, t2, n2, a2, r2), !(Math.abs(o2 - i2) <= 0.01); )
      r2 += (o2 < i2 ? 1 : -1) * (l2 /= 2);
    return r2;
  }
  function we(e2, n2) {
        ...
        case T:
          !function() {
            ...
            function e3() {
              ...
              if (o4[0] === o4[1]) {
                if (n3[0] && n3[1])
                  return y3(h3[1], h3[0]) || (h3[0][o4[0]] === h3[1][o4[1]] ? (u3[0].push(h3[0]), u3[1].push(h3[1])) : (e4 = h3[0][o4[0]] + (h3[1][o4[1]] - h3[0][o4[0]]) / 2, u3[0].push(d3(h3[0], Math.abs(e4 - h3[0][o4[0]]))), u3[1].push(d3(h3[1], Math.abs(e4 - h3[1][o4[1]]))))), false;
                ...
                if (n3[0] && n3[1])
                  return y3(h3[1], h3[0]) ? u3[1].push(h3[1]) : y3(h3[0], h3[1]) ? u3[0].push(h3[0]) : u3[0].push("x" === o4[0] ? {
                    x: h3[1].x,
                    y: h3[0].y
                  } : {
                    x: h3[0].x,
  ...
  function Ze(s2, u2) {
    ...
    function d2(e3, t2, n2, a2, i3, o2, l2, r2, s3) {
      ...
      if (!a2) {
        if (null == d3.default)
          throw new Error("Invalid `type`: " + n2);
    ...
    if (u2 = u2 || {}, ["start", "end"].forEach(function(e3, t2) {
      ...
      if (n2 && (ye(n2) || (a2 = _(n2, "anchor"))) && n2 !== h2.anchorSE[t2]) {
        if (false !== s2.optionIsAttach.anchorSE[t2] && Ue(s2, $[h2.anchorSE[t2]._id]), a2 && !He(s2, $[n2._id], e3))
          throw new Error("Can't bind attachment");
        h2.anchorSE[t2] = n2, s2.optionIsAttach.anchorSE[t2] = a2, i2 = p2.position = true;
      }
    }), !h2.anchorSE[0] || !h2.anchorSE[1] || h2.anchorSE[0] === h2.anchorSE[1])
      throw new Error("`start` and `end` are required.");
    i2 && (e2 = function(e3, t2) {
      var n2, a2, i3;
      if (!(n2 = me(e3)) || !(a2 = me(t2)))
      ...
      if ((n2 = "string" == typeof o2) && (o2 = o2.trim()), (n2 || o2 && (r2 = _(o2, "label"))) && o2 !== l2) {
        if (h2.labelSEM[t2] && (Ue(s2, $[h2.labelSEM[t2]._id]), h2.labelSEM[t2] = ""), o2) {
          ...
          }) : i3 = new S(y.captionLabel, [o2]), !He(s2, $[i3._id], e3))
            throw new Error("Can't bind attachment");
          h2.labelSEM[t2] = i3;
        }
  ...
  return te = {
    ...
    mouseHoverAnchor: {
      ...
      init: function(a2, i2) {
        ...
        if (a2.element = y.pointAnchor.checkElement(i2.element), u2 = a2.element, !((p2 = u2.ownerDocument) && (h2 = p2.defaultView) && h2.HTMLElement && u2 instanceof h2.HTMLElement))
    ...
    captionLabel: {
      ...
      getMidPoint: function(e2, t2) {
        ...
        if ((n2 = r2 / 2 + (t2 || 0)) <= 0)
          return 2 === (a2 = e2[0]).length ? ve(a2[0], a2[1], 0) : xe(a2[0], a2[1], a2[2], a2[3], 0);
        if (r2 <= n2)
          return 2 === (a2 = e2[e2.length - 1]).length ? ve(a2[0], a2[1], 1) : xe(a2[0], a2[1], a2[2], a2[3], 1);
        for (i2 = []; n2 > l2[++s2]; )
          i2.push(e2[s2]), n2 -= l2[s2];
